...
| FEAT-003 | Historique des inscriptions par enfant | 5 | Must | Feature majeure | READY | (pref. apres FEAT-002) |
| FEAT-004 | Tracabilite factures (cree par / valide par) | 3 | Should | Feature majeure | READY | sequencer migration avec FEAT-005 |
