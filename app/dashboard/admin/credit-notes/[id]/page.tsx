...
export default async function CreditNoteDetailsPage({ params }: PageProps) {
  ...
  return (
    <BreadcrumbProvider
      items={[
        ...
        { href: '/dashboard/admin/credit-notes', label: 'Avoirs' },
    ...
    >
      <div className="space-y-6">
        <PageHeader
          ...
          actions={<CreditNoteActions creditNote={creditNote} />}
        />
